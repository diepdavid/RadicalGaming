...
namespace RadicalGaming.DataAccess.Migrations
{
    ...
    [Migration("20240324214649_addOrderDetailsAndOrderHeaderToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RadicalGaming.Model.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RadicalGaming.Model.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RadicalGaming.Model.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RadicalGaming.Model.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("RadicalGaming.Model.OrderDetail", b =>
                {
                    b.HasOne("RadicalGaming.Model.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RadicalGaming.Model.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("RadicalGaming.Model.ShoppingCart", b =>
                {
                    b.HasOne("RadicalGaming.Model.ApplicationUser", "ApplicationUser")
                        .WithMany()
